//-----------------------------------------------------------------------
// <copyright file="AudiosInicioUI.cs" company="LG Sistemas">
...
{
    public class AudiosInicioUI : PaginaPadrao
    {
        private AdministracaoUI _adminUI;

        public AudiosInicioUI(ComponenteDeTela componenteDeTela, AdministracaoUI adminUI)
        ...
        {
            ComponenteDeTela.Script.ExecuteCodigoJavaScript("$('.cadastro-de-audio')[0].click()");
        }
