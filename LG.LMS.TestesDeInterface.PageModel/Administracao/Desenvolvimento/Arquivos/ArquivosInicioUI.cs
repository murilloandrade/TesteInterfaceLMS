//-----------------------------------------------------------------------
// <copyright file="ArquivosInicioUI.cs" company="LG Sistemas">
...
{
    public class ArquivosInicioUI : PaginaPadrao
    {
        private AdministracaoUI _adminUI;

        public ArquivosInicioUI(ComponenteDeTela componenteDeTela, AdministracaoUI adminUI)
        ...
        {
            ComponenteDeTela.Script.ExecuteCodigoJavaScript("$('.cadastro-de-arquivo')[0].click()");
        }
