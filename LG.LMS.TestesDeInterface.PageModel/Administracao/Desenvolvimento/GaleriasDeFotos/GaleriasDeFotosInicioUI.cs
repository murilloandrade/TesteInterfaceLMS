//-----------------------------------------------------------------------
// <copyright file="GaleriasDeFotosInicioUI.cs" company="LG Sistemas">
...
{
    public class GaleriasDeFotosInicioUI : PaginaPadrao
    {
        ...
        {
            ComponenteDeTela.Script.ExecuteCodigoJavaScript("$('.cadastro-de-galeria')[0].click()");
        }
        ...
        protected override void CarregarPagina()
        {
            ...
            _adminUI.CliqueGaleriasDeFotos();
        }
    }
}
